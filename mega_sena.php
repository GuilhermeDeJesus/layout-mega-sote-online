...
<div class="row">
	...
	<div class="col-md-6">
		<div
			style="border-bottom: 3px solid #008B45; border-right: 3px solid #008B45; margin-left: -6px; border-radius: 5px; width: 100%; background: #FFF; margin-top: 25px; margin-bottom: 0px;">
			<h3
			...
			<div
				style="width: 600px; height: 30px; border-radius: 10px; text-align: center; background-color: #008B45; float: left; margin-left: 210px; border: 3px solid #CCC; margin-top: -3.9%;">
				<h5 style="color: #FFF; margin-top: 5px; margin-left: 10px;">Concurso:
					12345 | Prêmio Estimado: R$ 10.000,00 | Data Sortei: 25/05/2015</h5>
			</div>
		</div>
		<div class="loteria-mega-sena">
			<div id="numeros-aposta-left-mega" style="display: block">
				<h5 style="font-size: 18px; text-align: center; color: #000; font-weight: bolder; opacity: 0.8;">ESCOLHA SUAS DEZENAS</h5>
				<div class="dezenas-mega-sena">
    				<?php
                    $maiorDezena = 60;
                    for ($i = 1; $i <= $maiorDezena; $i ++) {
                        if ($i < 10)
                            ...
                            $n = $i;
                        ?>
    				<button id="dezenas-mg" class="dezena <?=$i ?>" value="<?=$i ?>">
